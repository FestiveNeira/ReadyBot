    ...
    generics: new Map([
        ['nicebot', {
            ...
            execute(message, bot) {
                ...
                if (!nomsgs) {
                    if (red) {
                        if ((msg.includes("good morn") || msg.includes("gm")) && (time.getHours() > 4 && time.getHours() < 12)) {
                        ...
                        if (msg.includes("thx") || msg.includes("thank")) {
                            if (up) {
                        ...
                        if (msg.includes("ily") || msg.includes("i love you") || msg.includes("i ❤️ you")) {
                            message.channel.send("That's really weird, but thanks! 😊");
                        }
                    }
